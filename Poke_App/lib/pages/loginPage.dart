import 'package:flutte_pokedex/providers/usuarioProvider.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void validateAndSubmit() async {
    ...
    if (validateAndSave()) {
      ...
      try {
        if (_isLoginForm) {
          Map info = await usuarioProvider.login(_email, _password);
          if ( info['ok'] ) {
            Navigator.pushReplacementNamed(context, '/principalPage');
          } else {
             print(info);
          } 
        } else {
          Map info = await usuarioProvider.nuevoUsuario(_email, _password);
          if ( info['ok'] ) {
